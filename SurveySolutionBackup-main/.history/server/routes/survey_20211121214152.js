...
router.post('/view/:id', (req, res, next) => {
  ...
  let id = req.params.id
  let ans1 = "";
  if (req.body.answerT1.isChecked()) ans1 = "TRUE";
  if (req.body.answerF1.isChecked()) ans1 = "FALSE";
  let ans2 = "";
  if (req.body.answerT2.isChecked()) ans2 = "TRUE";
  if (req.body.answerF2.isChecked()) ans2 = "FALSE";
  let ans3 = "";
  if (req.body.answerT3.isChecked()) ans3 = "TRUE";
  if (req.body.answerF3.isChecked()) ans3 = "FALSE";
  let ans4 = "";
  if (req.body.answerT4.isChecked()) ans4 = "TRUE";
  if (req.body.answerF4.isChecked()) ans4 = "FALSE";
  let updatedSurvey = survey({
    "_id" : id,
    "title" : req.body.title,
    "startDate" : req.body.startDate,
